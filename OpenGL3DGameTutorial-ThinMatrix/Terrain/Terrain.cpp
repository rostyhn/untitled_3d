...
Terrain::Terrain(int gridX, int gridZ, Loader& loader, ModelTexture t, bool isMiddle)
	: m_x(gridX * SIZE), m_z(gridZ * SIZE), m_texture(t), m_model(GenerateTerrain(loader)), isMiddle(isMiddle)
{
}
...
void Terrain::setMiddle()
{
	isMiddle = (isMiddle == false) ? true : false;
}
