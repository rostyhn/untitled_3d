...
#include "../src/RenderEngine/MasterRenderer.h"
...
void RunState::generateNewLand(const glm::vec3 position, std::vector<Terrain>& terrains, std::vector<Entity>& entities, Loader &loader)
{
